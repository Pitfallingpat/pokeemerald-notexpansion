...
{
	SPECIES_TO_HOENN(COYULA),
	SPECIES_TO_HOENN(WILYOTE),
	SPECIES_TO_HOENN(DREAYOLA),
	SPECIES_TO_HOENN(CAMPEAR),
	SPECIES_TO_HOENN(REBLRIZZ),
	SPECIES_TO_HOENN(SMOKARCH),
	SPECIES_TO_HOENN(BOTOFIN),
	SPECIES_TO_HOENN(SONARIN),
	SPECIES_TO_HOENN(GLADIPHON),
	...
	SPECIES_TO_HOENN(GEOBOI),
	SPECIES_TO_HOENN(GRAVLOON),
	SPECIES_TO_HOENN(GOLAEDER),
...
//	HOENN_DEX_PRISM3),
	...
	//Forms in Regional dex
	
	[SPECIES_TANGELA_REGIONAL - 1] = HOENN_DEX_TANGELA,
	[SPECIES_TANGROWTH_REGIONAL - 1] = HOENN_DEX_TANGROWTH,
	[SPECIES_SHELLOS_REGIONAL - 1] = HOENN_DEX_SHELLOS,
	[SPECIES_GASTRODON_REGIONAL - 1] = HOENN_DEX_GASTRODON,
	[SPECIES_SHELLOS_EAST_SEA - 1] = HOENN_DEX_SHELLOS,
	[SPECIES_GASTRODON_EAST_SEA - 1] = HOENN_DEX_GASTRODON,
	[SPECIES_RALTS_REGIONAL - 1 ] = HOENN_DEX_RALTS,
	[SPECIES_KIRLIA_REGIONAL - 1 ] = HOENN_DEX_KIRLIA,
	[SPECIES_GARDEVOIR_REGIONAL - 1 ] = HOENN_DEX_GARDEVOIR,
	[SPECIES_GARDEVOIR_REGIONAL_MEGA - 1 ] = HOENN_DEX_GARDEVOIR,
	[SPECIES_GALLADE_REGIONAL - 1 ] = HOENN_DEX_GALLADE,
	[SPECIES_GALLADE_REGIONAL_MEGA - 1 ] = HOENN_DEX_GALLADE,
	[SPECIES_REGIGIGAS_PRIMAL - 1 ] = HOENN_DEX_REGIGIGAS,
	[SPECIES_FABULA_MESSY - 1] = HOENN_DEX_FABULA,
};
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
	...
	SPECIES_TO_NATIONAL(COYULA),
	SPECIES_TO_NATIONAL(WILYOTE),
	SPECIES_TO_NATIONAL(DREAYOLA),
	SPECIES_TO_NATIONAL(CAMPEAR),
	SPECIES_TO_NATIONAL(REBLRIZZ),
	SPECIES_TO_NATIONAL(SMOKARCH),
	SPECIES_TO_NATIONAL(BOTOFIN),
	SPECIES_TO_NATIONAL(SONARIN),
	SPECIES_TO_NATIONAL(GLADIPHON),
	SPECIES_TO_NATIONAL(GEOBOI),
	SPECIES_TO_NATIONAL(GRAVLOON),
	SPECIES_TO_NATIONAL(GOLAEDER),
	SPECIES_TO_NATIONAL(FABULA),
	SPECIES_TO_NATIONAL(CRABOMINATE),
	SPECIES_TO_NATIONAL(REGIPYRE),
...
#endif
	[SPECIES_TANGELA_REGIONAL - 1] = NATIONAL_DEX_TANGELA,
	[SPECIES_TANGROWTH_REGIONAL - 1] = NATIONAL_DEX_TANGROWTH,
	[SPECIES_SHELLOS_REGIONAL - 1] = NATIONAL_DEX_SHELLOS,
	[SPECIES_GASTRODON_REGIONAL - 1] = NATIONAL_DEX_GASTRODON,
	[SPECIES_RALTS_REGIONAL - 1 ] = NATIONAL_DEX_RALTS,
	[SPECIES_KIRLIA_REGIONAL - 1 ] = NATIONAL_DEX_KIRLIA,
	[SPECIES_GARDEVOIR_REGIONAL - 1 ] = NATIONAL_DEX_GARDEVOIR,
	[SPECIES_GARDEVOIR_REGIONAL_MEGA - 1 ] = NATIONAL_DEX_GARDEVOIR,
	[SPECIES_GALLADE_REGIONAL - 1 ] = NATIONAL_DEX_GALLADE,
	[SPECIES_GALLADE_REGIONAL_MEGA - 1 ] = NATIONAL_DEX_GALLADE,
	[SPECIES_REGIGIGAS_PRIMAL - 1 ] = NATIONAL_DEX_REGIGIGAS,
	[SPECIES_FABULA_MESSY - 1] = NATIONAL_DEX_FABULA,
};
...
{
	[SPECIES_TANGELA_REGIONAL - 1] = ANIM_V_SHAKE,
	[SPECIES_COYULA - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_WILYOTE - 1 ] = ANIM_H_SLIDE,
	[SPECIES_DREAYOLA - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_CAMPEAR - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_REBLRIZZ - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_SMOKARCH - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_BOTOFIN - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_SONARIN - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_GLADIPHON - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_GEOBOI - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_GRAVLOON - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_GOLAEDER - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_FABULA - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_CRABOMINATE - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_REGIPYRE - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_RALTS_REGIONAL - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_KIRLIA_REGIONAL - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_GARDEVOIR_REGIONAL - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_GARDEVOIR_REGIONAL_MEGA - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_GALLADE_REGIONAL - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_GALLADE_REGIONAL_MEGA - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_SHELLOS_REGIONAL - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_GASTRODON_REGIONAL - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_TANGROWTH_REGIONAL - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_REGIGIGAS_PRIMAL - 1 ] =  ANIM_H_SLIDE,
	[SPECIES_FABULA_MESSY - 1 ] =  ANIM_H_SLIDE,
    ...
    for (i = 0; i < ITEM_EFFECT_ARG_START; i++)
    {
        ...
        case 3:
            ...
            if ((itemEffect[i] & ITEM3_PARALYSIS) && HealStatusConditions(mon, partyIndex, STATUS1_PARALYSIS, battlerId) == 0)
                retVal = FALSE;
			if ((itemEffect[i] & ITEM3_BRUISE) && HealStatusConditions(mon, partyIndex, STATUS1_BRUISE, battlerId) == 0)
                retVal = FALSE;
            break;
