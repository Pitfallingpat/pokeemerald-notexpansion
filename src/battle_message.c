...
static const u8 sText_PkmnWasBruised[] = _("{B_EFF_NAME_WITH_PREFIX} got bruised!");
...
static const u8 sText_PkmnHurtByBruise[] = _("{B_ATK_NAME_WITH_PREFIX} is hurt\nby its bruises!");
...
static const u8 sText_PkmnsXPreventsBruises[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_EFF_ABILITY}\nprevents bruises!");
...
static const u8 sText_PkmnsItemHealedBruise[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nhealed its bruises!");
...
static const u8 sText_PkmnBruiseHealed[] = _("{B_DEF_NAME_WITH_PREFIX}'s\nbruises were healed.");
...
static const u8 sText_AttackerHealedItsBruise[] = _("{B_ATK_NAME_WITH_PREFIX} healed its bruises with\nits sheer determination!");
...
static const u8 sText_UnstoppableEnters[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is unstoppable!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_ATTACKERHEALEDITSBRUISE - BATTLESTRINGS_TABLE_START] = sText_AttackerHealedItsBruise,
    ...
    [STRINGID_PKMNBRUISEHEALED - BATTLESTRINGS_TABLE_START] = sText_PkmnBruiseHealed,
    ...
    [STRINGID_PKMNWASBRUISED - BATTLESTRINGS_TABLE_START] = sText_PkmnWasBruised,
    ...
    [STRINGID_PKMNHURTBYBRUISE - BATTLESTRINGS_TABLE_START] = sText_PkmnHurtByBruise,
    ...
    [STRINGID_PKMNSITEMHEALEDBRUISE - BATTLESTRINGS_TABLE_START] = sText_PkmnsItemHealedBruise,
    ...
    [STRINGID_PKMNSXPREVENTSBRUISE - BATTLESTRINGS_TABLE_START] = sText_PkmnsXPreventsBruises,
    ...
    [STRINGID_TEAMGAINEDEXP - BATTLESTRINGS_TABLE_START] = sText_TeamGainedEXP,
  	[STRINGID_UNSTOPPABLEENTERS - BATTLESTRINGS_TABLE_START] = sText_UnstoppableEnters,
...
{
	[B_MSG_SWITCHIN_UNSTOPPABLE] = STRINGID_UNSTOPPABLEENTERS,
...
const u16 gGotBruisedStringIds[] =
{
    [B_MSG_STATUSED]            = STRINGID_PKMNWASBRUISED,
...
const u8 gText_MoveInterfacePpType[] = _("PP {PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}PP\nTYPE/");
