...
const struct TypeInfo gTypesInfo[NUMBER_OF_MON_TYPES] =
{
	...
	[TYPE_SOUND] = 
	{
        ...
        .palette = 14,
        .zMove = MOVE_TWINKLE_TACKLE, //TODO Z-Move
        .maxMove = MOVE_MAX_STARFALL, //TODO Max-Move
	},
	[TYPE_LASER] = 
	{
		.name = _("Laser"),
        .generic = _("a LASER move"),
        .palette = 14,
        .zMove = MOVE_TWINKLE_TACKLE, //TODO Z-Move
        .maxMove = MOVE_MAX_STARFALL, //TODO Max-Move
	}
...
void SetTypeBeforeUsingMove(u32 move, u32 battlerAtk)
{
    ...
    else if (gMovesInfo[move].effect == EFFECT_HIDDEN_POWER)
    {
		...
		*/
		...
		gBattleStruct->dynamicMoveType = (gBattleMons[battlerAtk].personality % 19) + 2;
