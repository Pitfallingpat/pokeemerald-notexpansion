...
{
	SPECIES_SPRITE(TANGELA_REGIONAL, gMonBackPic_TangelaRegional),
	SPECIES_SPRITE(COYULA, gMonBackPic_Coyula),
	SPECIES_SPRITE(WILYOTE, gMonBackPic_Wilyote),
	SPECIES_SPRITE(DREAYOLA, gMonBackPic_Dreayola),
	SPECIES_SPRITE(CAMPEAR, gMonBackPic_Campear),
	SPECIES_SPRITE(REBLRIZZ, gMonBackPic_Reblrizz),
	SPECIES_SPRITE(SMOKARCH, gMonBackPic_Smokarch),
	SPECIES_SPRITE(BOTOFIN, gMonBackPic_Botofin),
	SPECIES_SPRITE(SONARIN, gMonBackPic_Sonarin),
	SPECIES_SPRITE(GLADIPHON, gMonBackPic_Gladiphon),
	SPECIES_SPRITE(GEOBOI, gMonBackPic_Geoboi),
	SPECIES_SPRITE(GRAVLOON, gMonBackPic_Gravloon),
	SPECIES_SPRITE(GOLAEDER, gMonBackPic_Golaeder),
	SPECIES_SPRITE(FABULA, gMonBackPic_Fabula),
	SPECIES_SPRITE(CRABOMINATE, gMonBackPic_Crabominate),
	SPECIES_SPRITE(REGIPYRE, gMonBackPic_Regipyre),
	SPECIES_SPRITE(RALTS_REGIONAL, gMonBackPic_RaltsRegional),
	SPECIES_SPRITE(KIRLIA_REGIONAL, gMonBackPic_KirliaRegional),
	SPECIES_SPRITE(GARDEVOIR_REGIONAL, gMonBackPic_GardevoirRegional),
	SPECIES_SPRITE(GARDEVOIR_REGIONAL_MEGA, gMonBackPic_GardevoirRegionalMega),
	SPECIES_SPRITE(GALLADE_REGIONAL, gMonBackPic_GalladeRegional),
	SPECIES_SPRITE(GALLADE_REGIONAL_MEGA, gMonBackPic_GalladeRegionalMega),
	SPECIES_SPRITE(SHELLOS_REGIONAL, gMonBackPic_ShellosRegional),
	SPECIES_SPRITE(GASTRODON_REGIONAL, gMonBackPic_GastrodonRegional),
	SPECIES_SPRITE(TANGROWTH_REGIONAL, gMonBackPic_TangrowthRegional),
	SPECIES_SPRITE(REGIGIGAS_PRIMAL, gMonBackPic_RegigigasPrimal),
	SPECIES_SPRITE(FABULA_MESSY, gMonBackPic_FabulaMessy),
	//
