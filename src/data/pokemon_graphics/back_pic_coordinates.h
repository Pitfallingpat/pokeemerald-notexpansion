...
{
	[SPECIES_TANGELA_REGIONAL]  		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_COYULA] 			  	       = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_WILYOTE] 			  	       = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_DREAYOLA] 			   	       = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_CAMPEAR] 			 	       = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_REBLRIZZ] 			  	       = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_SMOKARCH] 			  		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_BOTOFIN] 					   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_SONARIN] 					   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_GLADIPHON] 			       = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_GEOBOI] 			 		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_GRAVLOON] 			   		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_GOLAEDER] 			   	       = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_FABULA] 			   		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_CRABOMINATE] 			       = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_REGIPYRE] 			   		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_RALTS_REGIONAL] 			   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_KIRLIA_REGIONAL] 			   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_GARDEVOIR_REGIONAL] 		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_GARDEVOIR_REGIONAL_MEGA] 	   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_GALLADE_REGIONAL] 			   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_GALLADE_REGIONAL_MEGA] 	   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_SHELLOS_REGIONAL] 			   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_GASTRODON_REGIONAL] 		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_TANGROWTH_REGIONAL] 		   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_REGIGIGAS_PRIMAL] 			   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
	[SPECIES_FABULA_MESSY]  			   = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 12  },
