...
{
	SPECIES_SPRITE(TANGELA_REGIONAL, gMonFrontPic_TangelaRegional),
	SPECIES_SPRITE(COYULA, gMonFrontPic_Coyula),
	SPECIES_SPRITE(WILYOTE, gMonFrontPic_Wilyote),
	SPECIES_SPRITE(DREAYOLA, gMonFrontPic_Dreayola),
	SPECIES_SPRITE(CAMPEAR, gMonFrontPic_Campear),
	SPECIES_SPRITE(REBLRIZZ, gMonFrontPic_Reblrizz),
	SPECIES_SPRITE(SMOKARCH, gMonFrontPic_Smokarch),
	SPECIES_SPRITE(BOTOFIN, gMonFrontPic_Botofin),
	SPECIES_SPRITE(SONARIN, gMonFrontPic_Sonarin),
	SPECIES_SPRITE(GLADIPHON, gMonFrontPic_Gladiphon),
	SPECIES_SPRITE(GEOBOI, gMonFrontPic_Geoboi),
	SPECIES_SPRITE(GRAVLOON, gMonFrontPic_Gravloon),
	SPECIES_SPRITE(GOLAEDER, gMonFrontPic_Golaeder),
	SPECIES_SPRITE(FABULA, gMonFrontPic_Fabula),
	SPECIES_SPRITE(CRABOMINATE, gMonFrontPic_Crabominate),
	SPECIES_SPRITE(REGIPYRE, gMonFrontPic_Regipyre),
	SPECIES_SPRITE(RALTS_REGIONAL, gMonFrontPic_RaltsRegional),
	SPECIES_SPRITE(KIRLIA_REGIONAL, gMonFrontPic_KirliaRegional),
	SPECIES_SPRITE(GARDEVOIR_REGIONAL, gMonFrontPic_GardevoirRegional),
	SPECIES_SPRITE(GARDEVOIR_REGIONAL_MEGA, gMonFrontPic_GardevoirRegionalMega),
	SPECIES_SPRITE(GALLADE_REGIONAL, gMonFrontPic_GalladeRegional),
	SPECIES_SPRITE(GALLADE_REGIONAL_MEGA, gMonFrontPic_GalladeRegionalMega),
	SPECIES_SPRITE(SHELLOS_REGIONAL, gMonFrontPic_ShellosRegional),
	SPECIES_SPRITE(GASTRODON_REGIONAL, gMonFrontPic_GastrodonRegional),
	SPECIES_SPRITE(TANGROWTH_REGIONAL, gMonFrontPic_TangrowthRegional),
	SPECIES_SPRITE(REGIGIGAS_PRIMAL, gMonFrontPic_RegigigasPrimal),
	SPECIES_SPRITE(FABULA_MESSY, gMonFrontPic_FabulaMessy),
