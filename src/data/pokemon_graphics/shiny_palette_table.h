...
{
	SPECIES_SHINY_PAL(TANGELA_REGIONAL, gMonShinyPalette_TangelaRegional),
	SPECIES_SHINY_PAL(COYULA, gMonShinyPalette_Coyula),
	SPECIES_SHINY_PAL(WILYOTE, gMonShinyPalette_Wilyote),
	SPECIES_SHINY_PAL(DREAYOLA, gMonShinyPalette_Dreayola),
	SPECIES_SHINY_PAL(CAMPEAR, gMonShinyPalette_Campear),
	SPECIES_SHINY_PAL(REBLRIZZ, gMonShinyPalette_Reblrizz),
	SPECIES_SHINY_PAL(SMOKARCH, gMonShinyPalette_Smokarch),
	SPECIES_SHINY_PAL(BOTOFIN, gMonShinyPalette_Botofin),
	SPECIES_SHINY_PAL(SONARIN, gMonShinyPalette_Sonarin),
	SPECIES_SHINY_PAL(GLADIPHON, gMonShinyPalette_Gladiphon),
	SPECIES_SHINY_PAL(GEOBOI, gMonShinyPalette_Geoboi),
	SPECIES_SHINY_PAL(GRAVLOON, gMonShinyPalette_Gravloon),
	SPECIES_SHINY_PAL(GOLAEDER, gMonShinyPalette_Golaeder),
	SPECIES_SHINY_PAL(FABULA, gMonShinyPalette_Fabula),
	SPECIES_SHINY_PAL(CRABOMINATE, gMonShinyPalette_Crabominate),
	SPECIES_SHINY_PAL(REGIPYRE, gMonShinyPalette_Regipyre),
	SPECIES_SHINY_PAL(RALTS_REGIONAL, gMonShinyPalette_RaltsRegional),
	SPECIES_SHINY_PAL(KIRLIA_REGIONAL, gMonShinyPalette_KirliaRegional),
	SPECIES_SHINY_PAL(GARDEVOIR_REGIONAL, gMonShinyPalette_GardevoirRegional),
	SPECIES_SHINY_PAL(GARDEVOIR_REGIONAL_MEGA, gMonShinyPalette_GardevoirRegionalMega),
	SPECIES_SHINY_PAL(GALLADE_REGIONAL, gMonShinyPalette_GalladeRegional),
	SPECIES_SHINY_PAL(GALLADE_REGIONAL_MEGA, gMonShinyPalette_GalladeRegionalMega),
	SPECIES_SHINY_PAL(SHELLOS_REGIONAL, gMonShinyPalette_ShellosRegional),
	SPECIES_SHINY_PAL(GASTRODON_REGIONAL, gMonShinyPalette_GastrodonRegional),
	SPECIES_SHINY_PAL(TANGROWTH_REGIONAL, gMonShinyPalette_TangrowthRegional),
	SPECIES_SHINY_PAL(REGIGIGAS_PRIMAL, gMonShinyPalette_RegigigasPrimal),
	SPECIES_SHINY_PAL(FABULA_MESSY, gMonShinyPalette_FabulaMessy),
	//
