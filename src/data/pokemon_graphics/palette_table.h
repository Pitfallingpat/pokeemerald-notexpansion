...
{
	SPECIES_PAL(TANGELA_REGIONAL, gMonPalette_TangelaRegional),
	SPECIES_PAL(COYULA, gMonPalette_Coyula),
	SPECIES_PAL(WILYOTE, gMonPalette_Wilyote),
	SPECIES_PAL(DREAYOLA, gMonPalette_Dreayola),
	SPECIES_PAL(CAMPEAR, gMonPalette_Campear),
	SPECIES_PAL(REBLRIZZ, gMonPalette_Reblrizz),
	SPECIES_PAL(SMOKARCH, gMonPalette_Smokarch),
	SPECIES_PAL(BOTOFIN, gMonPalette_Botofin),
	SPECIES_PAL(SONARIN, gMonPalette_Sonarin),
	SPECIES_PAL(GLADIPHON, gMonPalette_Gladiphon),
	SPECIES_PAL(GEOBOI, gMonPalette_Geoboi),
	SPECIES_PAL(GRAVLOON, gMonPalette_Gravloon),
	SPECIES_PAL(GOLAEDER, gMonPalette_Golaeder),
	SPECIES_PAL(FABULA, gMonPalette_Fabula),
	SPECIES_PAL(CRABOMINATE, gMonPalette_Crabominate),
	SPECIES_PAL(REGIPYRE, gMonPalette_Regipyre),
	SPECIES_PAL(RALTS_REGIONAL, gMonPalette_RaltsRegional),
	SPECIES_PAL(KIRLIA_REGIONAL, gMonPalette_KirliaRegional),
	SPECIES_PAL(GARDEVOIR_REGIONAL, gMonPalette_GardevoirRegional),
	SPECIES_PAL(GARDEVOIR_REGIONAL_MEGA, gMonPalette_GardevoirRegionalMega),
	SPECIES_PAL(GALLADE_REGIONAL, gMonPalette_GalladeRegional),
	SPECIES_PAL(GALLADE_REGIONAL_MEGA, gMonPalette_GalladeRegionalMega),
	SPECIES_PAL(SHELLOS_REGIONAL, gMonPalette_ShellosRegional),
	SPECIES_PAL(GASTRODON_REGIONAL, gMonPalette_GastrodonRegional),
	SPECIES_PAL(TANGROWTH_REGIONAL, gMonPalette_TangrowthRegional),
	SPECIES_PAL(REGIGIGAS_PRIMAL, gMonPalette_RegigigasPrimal),
	SPECIES_PAL(FABULA_MESSY, gMonPalette_FabulaMessy),
