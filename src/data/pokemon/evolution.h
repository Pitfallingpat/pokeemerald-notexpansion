const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MAGNETON]              = {{EVO_MAPSEC, MAPSEC_NONE, SPECIES_MAGNEZONE},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_NOSEPASS]              = {{EVO_MAPSEC, MAPSEC_NONE, SPECIES_PROBOPASS},
    ...
    [SPECIES_CHARJABUG]             = {{EVO_MAPSEC, MAPSEC_NONE, SPECIES_VIKAVOLT},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_VIKAVOLT}},
    [SPECIES_CRABRAWLER]            = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_CRABOMINABLE}},//{{EVO_SPECIFIC_MAP, MAP_SHOAL_CAVE_LOW_TIDE_ICE_ROOM, SPECIES_CRABOMINABLE},
...
#endif
	[SPECIES_COYULA] = {{EVO_LEVEL, 16, SPECIES_WILYOTE}},
	[SPECIES_WILYOTE] = {{EVO_LEVEL, 36, SPECIES_DREAYOLA}},
	[SPECIES_CAMPEAR] = {{EVO_LEVEL, 16, SPECIES_REBLRIZZ}},
	[SPECIES_REBLRIZZ] = {{EVO_LEVEL, 36, SPECIES_SMOKARCH}},
	[SPECIES_BOTOFIN] = {{EVO_LEVEL, 16, SPECIES_SONARIN}},
	[SPECIES_SONARIN] = {{EVO_LEVEL, 36, SPECIES_GLADIPHON}},
	
	[SPECIES_GEOBOI] = {{EVO_LEVEL, 25, SPECIES_GRAVLOON}},
	[SPECIES_GRAVLOON] = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOLAEDER},
						  {EVO_TRADE, 0, SPECIES_GOLAEDER}},
	[SPECIES_TANGELA_REGIONAL] = {{EVO_FRIENDSHIP, 1, SPECIES_FABULA},
								  {EVO_MOVE, MOVE_ANCIENT_POWER, SPECIES_TANGROWTH_REGIONAL}},
    [SPECIES_RALTS_REGIONAL] = {{EVO_LEVEL, 20, SPECIES_KIRLIA_REGIONAL}},
    [SPECIES_KIRLIA_REGIONAL] = {{EVO_LEVEL, 30, SPECIES_GARDEVOIR_REGIONAL},
						         {EVO_ITEM_MALE, ITEM_DAWN_STONE, SPECIES_GALLADE_REGIONAL}},
    [SPECIES_SHELLOS_REGIONAL]   = {{EVO_LEVEL, 30, SPECIES_GASTRODON_REGIONAL}},
