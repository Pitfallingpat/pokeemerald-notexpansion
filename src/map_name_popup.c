...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
	...
	[MAPSEC_FRESH_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_HISTOR_TOWN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_PROSPECT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_PROSPECT_MINE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD
};
...
{
    [MAPSEC_FRESH_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_HISTOR_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PROSPECT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PROSPECT_MINE] = MAPPOPUP_THEME_BW_DEFAULT,
