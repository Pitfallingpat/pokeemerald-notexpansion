...
{   // Corresponds to gHealthboxElementsGfxTable (and the tables after it) in graphics.c
    ...
    HEALTHBOX_GFX_116,
    HEALTHBOX_GFX_117,
    HEALTHBOX_GFX_STATUS_BRS_BATTLER0,  //status brs
    HEALTHBOX_GFX_118,
    HEALTHBOX_GFX_119,
    ...
    HEALTHBOX_GFX_84,
    HEALTHBOX_GFX_85,
    HEALTHBOX_GFX_STATUS_FRB_BATTLER1, //status2 "FSB"
    HEALTHBOX_GFX_120,
    HEALTHBOX_GFX_121,
    HEALTHBOX_GFX_STATUS_BRS_BATTLER1, //status2 "BRS"
    HEALTHBOX_GFX_122,
    HEALTHBOX_GFX_123,
    ...
    HEALTHBOX_GFX_99,
    HEALTHBOX_GFX_100,
    HEALTHBOX_GFX_STATUS_FRB_BATTLER2, //status3 "FSB"
    HEALTHBOX_GFX_124,
    HEALTHBOX_GFX_125,
    HEALTHBOX_GFX_STATUS_BRS_BATTLER2, //status3 "BRS"
    HEALTHBOX_GFX_126,
    HEALTHBOX_GFX_127,
    ...
    HEALTHBOX_GFX_114,
    HEALTHBOX_GFX_115,
    HEALTHBOX_GFX_STATUS_FRB_BATTLER3, //status4 "FSB"
    HEALTHBOX_GFX_128,
    HEALTHBOX_GFX_129,
    HEALTHBOX_GFX_STATUS_BRS_BATTLER3, //status4 "BRS"
    HEALTHBOX_GFX_130,
    HEALTHBOX_GFX_131,
...
static void UpdateStatusIconInHealthbox(u8 healthboxSpriteId)
{
	...
	else if (status & STATUS1_BRUISE)
    {
        statusGfxPtr = GetHealthboxElementGfxPtr(GetStatusIconForBattlerId(HEALTHBOX_GFX_STATUS_BRS_BATTLER0, battlerId));
        statusPalId = PAL_STATUS_BRS;
    }
...
static u8 GetStatusIconForBattlerId(u8 statusElementId, u8 battlerId)
{
    ...
    case HEALTHBOX_GFX_STATUS_BRN_BATTLER0:
        ...
        break;
    case HEALTHBOX_GFX_STATUS_BRS_BATTLER0:
        if (battlerId == 0)
            ret = HEALTHBOX_GFX_STATUS_BRS_BATTLER0;
        else if (battlerId == 1)
            ret = HEALTHBOX_GFX_STATUS_BRS_BATTLER1;
        else if (battlerId == 2)
            ret = HEALTHBOX_GFX_STATUS_BRS_BATTLER2;
        else
            ret = HEALTHBOX_GFX_STATUS_BRS_BATTLER3;
        break;
    }
    return ret;
}
