...
#define OW_FLAG_PAUSE_TIME          0
#define OW_FLAG_NO_ENCOUNTER        FLAG_CHEAT_NO_ENCOUNTERS  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      FLAG_CHEAT_NO_TRAINERS  // If this flag is set, trainers will not battle the player unless they're talked to.
#define OW_FLAG_NO_COLLISION        FLAG_CHEAT_NO_COLLIDE  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
